...
TOKEN = '6164712381:AAHyYN9DUH42D7N7NS1Uc0roSwuoJXWT__8'
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "*Welcome to @SahilModzOwner DDOS Bot*", reply_markup=markup, parse_mode='Markdown')
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link to download Canary:* [Download Canary](https://t.me/SahilModz)", parse_mode='Markdown')
        ...
        bot.send_message(message.chat.id, "*Contact @SahilModzOwner*", parse_mode='Markdown')

...
TOKEN = '6164712381:AAF9-sW-AAElxdSTu0_wKbM68YcrVGjBSas'
MONGO_URI = 'mongodb+srv://Cluster0:Cluster0@cluster0.5mvg9ej.mongodb.net/danger?retryWrites=true&w=majority'
FORWARD_CHANNEL_ID = -1002175079890
CHANNEL_ID = -1002175079890
error_channel_id = -1002175079890
    ...
    try:
        ...
        if bot.attack_initiator:
            ...
            join_channel_button = types.InlineKeyboardButton(
                ...
                url="https://t.me/+uxCFPrfaihVlZGQ1"
            )
...
def handle_attack_command(message):
    ...
    chat_id = message.chat.id
    markup = types.InlineKeyboardMarkup()
    button1 = types.InlineKeyboardButton(text="🔥 𝗔𝗽𝗽𝗿𝗼𝘃𝗲 𝗡𝗼𝘄 𝗡𝗼𝘄 🔥", url="https://t.me/hostile_here")
    button2 = types.InlineKeyboardButton(text="💰 𝗮𝗻𝗱 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 𝗛𝗲𝗿𝗲 💰", url="https://t.me/c/1552878741/5233")
    markup.add(button1)
    markup.add(button2)
    ...
    try:
        ...
        if not user_data or user_data.get('plan', 0) == 0:
            bot.send_message(
                chat_id,
                "*❌ Access Denied! ❌*\n\n*You are not approved to use this bot.*\n\nApproval required. Contact the owner [@hostile_here] 🔒",
                parse_mode='Markdown',
                reply_markup=markup)
            return
...
def process_attack_command(message):
    try:
        ...
        markup = types.InlineKeyboardMarkup()
        button3 = types.InlineKeyboardButton(text="📢 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 📢", url="https://t.me/+uxCFPrfaihVlZGQ1")
    ...
    try:
        ...
        if not user_data:
            response = (
                ...
                "You can reach out here: [Owner](https://t.me/hostile_here) 🔒\n"
                "Or check the price list here: [Price List](https://t.me/c/1552878741/5233) 💰"
            )
            markup = types.InlineKeyboardMarkup()
            button1 = types.InlineKeyboardButton(text="📞 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 📞",
                                                 url="https://t.me/hostile_here")
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/c/1552878741/5233")
            markup.add(button1)
            markup.add(button2)
        else:
            ...
            button = types.InlineKeyboardButton(
                text="📢 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 📢", url="https://t.me/+uxCFPrfaihVlZGQ1")
            markup.add(button)
...
def rules_command(message):
    rules_text = (
        ...
        "*6. 📩 Report issues to [@DANGER_BOY_OP].*\n\n"
...
def help_command(message):
    ...
    button2 = types.InlineKeyboardButton(text="💸 𝗦𝗲𝗲 𝗣𝗿𝗶𝗰𝗲𝘀 💸",
                                         url="https://t.me/c/1552878741/5233")
    markup.add(button1) 
    markup.add(button2)
    try:
        bot.send_message(message.chat.id,
